  ...
  return (
    ...
    <div className="conatiner">
      ...
      <div className="parentConatainer">
        <div className="sliderButtonPrev">
          <span> &lt;</span>
        </div>
        <div className="slider">
            <img className='slides' src="https://img.freepik.com/free-photo/surprised-dark-haired-girl-posing-with-phone-well-dressed-young-lady-beret-expressing-amazement_197531-20410.jpg?w=740&t=st=1672232193~exp=1672232793~hmac=564fb1d983fcbf5dd5585575a9f7aaaf962ea881d47d1933836caae5e08c7d04" alt="image1" />
        </div>
        <div className="sliderButtonNext">
        <span>&gt;</span>
        </div>
      </div>
        <div className="dots">
